...
$estado=$_GET['estado'];
$id=$_GET['id'];
$fecha_actualizacion=$_GET['fecha'];
//echo($fecha_actualizacion);
$fecha_final=cambiaf_a_mysql($fecha_actualizacion); 

//////////////////////////////////////////actualiza estado de la fase
$sql="UPDATE gestion_fases set estado= '$estado', fecha_actualizacion= '$fecha_final' where id='$id'";
mysql_query($sql,$link);

//busco codigo actividad 
$res=mysql_query("SELECT cod_actividad FROM gestion_fases WHERE id=$id")or die();
$row=mysql_fetch_array($res);
$codigo_actividad=$row["cod_actividad"];

//busco el total de fases para una actividad
$result = "SELECT COUNT(estado) FROM gestion_fases where cod_actividad=$codigo_actividad;";
...
$result2 = "SELECT COUNT(estado) FROM gestion_fases where cod_actividad=$codigo_actividad and estado='2';";
...
$sql2="UPDATE gestion_actividades set completados=$completados where id='$codigo_actividad'";
...
$res=mysql_query("SELECT ooa.cod_obj_operativo FROM gestion_obj_operativos_actividades ooa WHERE ooa.cod_actividad=$codigo_actividad")or die();

while ($objetivo=mysql_fetch_array($res))//recorrido de todos los objetivos operativos de la actividad 
{	
	$cod_obj=$objetivo[0];
	$sql_promedio="Select avg(a.completados) promedio from gestion_actividades a inner join gestion_obj_operativos_actividades ooa on (ooa.cod_actividad=a.id) where ooa.cod_obj_operativo='$cod_obj'";
	$resultado=mysql_query($sql_promedio,$link);
	$prom=mysql_fetch_array($resultado);
	$p=$prom[0];
	$p=round($p);
	$p=(int)$p;
	mysql_query("update gestion_obj_operativos set completados='$p' where codigo='$cod_obj'",$link);//actualizar el objetivo
}

/////////////////////////////////////actualizo plan operativo
//busco codigo plan operativo
$res_plan=mysql_query("SELECT cod_plan_operativo FROM gestion_actividades WHERE id=$codigo_actividad")or die();
$result_plan=mysql_fetch_array($res_plan);
$codigo_plan_operativo=$result_plan["cod_plan_operativo"];
$sql_promedio_plan="Select avg(completados) promedio from gestion_obj_operativos where cod_plan_o_dir='$codigo_plan_operativo'";
$resultado_plan=mysql_query($sql_promedio_plan,$link);
$prom=mysql_fetch_array($resultado_plan);
$p=$prom[0];
$p=round($p);
$p=(int)$p;
mysql_query("update gestion_planes_operativos set completados='$p' where codigo='$codigo_plan_operativo'",$link);//actualizar el plan
/////////////////////////////////////


///////////////////////////////////////actualizar los objetivos estrategicos
//busco los objetivos estrategicos relacionados con el objetivo operativo
$res=mysql_query("SELECT cod_obj_e_dir FROM gestion_obje_objo_dir WHERE cod_obj_o_dir=$cod_obj")or die();
...
{	
	...
	$sql_promedio_objetivo="Select avg(a.completados) promedio from gestion_obj_operativos a inner join gestion_obje_objo_dir ooa on (ooa.cod_obj_o_dir=a.codigo) where ooa.cod_obj_e_dir='$cod_obj_estrategico'";
	...
	$p=round($p);
	$p=(int)$p;
	mysql_query("update gestion_obj_estrategicos_direcciones set completados='$p' where codigo='$cod_obj_estrategico'",$link);//actualizar el objetivo
}
/////////////////////////////////////

/////////////////////////////////////actualizo plan estrategico direccion
//busco codigo plan estrategico
$res_plan_estrategico=mysql_query("SELECT cod_plan_e_dir FROM gestion_obj_estrategicos_direcciones WHERE codigo=$cod_obj_estrategico")or die();
...
$sql_promedio_plan_estrategico="Select avg(completados) promedio from gestion_obj_estrategicos_direcciones where cod_plan_e_dir='$codigo_plan_estrategico_direccion'";
...
$p=round($p);
$p=(int)$p;
mysql_query("update gestion_planes_estrategicos_direcciones set completados='$p' where codigo='$codigo_plan_estrategico_direccion'",$link);//actualizar el plan
/////////////////////////////////////
...
$res=mysql_query("SELECT cod_obj_e_org FROM gestion_obje_org_dir WHERE cod_obj_e_dir=$cod_obj_estrategico")or die();
...
{	
	...
	$sql_promedio="Select avg(a.completados) promedio from gestion_obj_estrategicos_direcciones a inner join gestion_obje_org_dir ooa on (ooa.cod_obj_e_dir=a.codigo) where ooa.cod_obj_e_org='$cod_obj_organizacion'";
	$resultado_organizacion=mysql_query($sql_promedio,$link);
	$prom=mysql_fetch_array($resultado_organizacion);
	$p=$prom[0];
	$p=round($p);
	$p=(int)$p;
	mysql_query("update gestion_obj_estrategicos set completados='$p' where codigo='$cod_obj_organizacion'",$link);//actualizar el objetivo estrategico
}

/////////////////////////////////////actualizo plan estrategico organización
//busco codigo plan estrategico organización
$res_plan_estrategico=mysql_query("SELECT codigo_plan_estrategico FROM gestion_obj_estrategicos WHERE codigo=$cod_obj_organizacion")or die();
$result_plan_estrategico=mysql_fetch_array($res_plan_estrategico);
$codigo_plan_estrategico=$result_plan_estrategico["codigo_plan_estrategico"];
$sql_promedio_plan_estrategico="Select avg(completados) promedio from gestion_obj_estrategicos where codigo_plan_estrategico='$codigo_plan_estrategico'";
$resultado_plan_estrategico=mysql_query($sql_promedio_plan_estrategico,$link);
$prom=mysql_fetch_array($resultado_plan_estrategico);
$p=$prom[0];
$p=round($p);
$p=(int)$p;
mysql_query("update gestion_planes_estrategicos set completados='$p' where codigo='$codigo_plan_estrategico'",$link);//actualizar el plan
/////////////////////////////////////
...
/////////////////////////////FASES///////////////////////////////////////////////////
$data=mysql_query("select * from gestion_fases where id='$id'",$link);
...
mysql_query("update gestion_fases set tiempo_ejecucion='$tiempo' where id='$id'",$link);//actualizar     
/////////////////////////////FASES///////////////////////////////////////////////////


/////////////////////////////ACTIVIDADES////////////////////////////////////////////
$consulta_tiempo=mysql_query("select COUNT(id), SUM(tiempo_ejecucion) from gestion_fases where cod_actividad=$codigo_actividad") or die (mysql_error);
//echo $tiempo[0];
//echo $tiempo[1];
...
{
$data_actividad=mysql_query("select * from gestion_actividades where id=$codigo_actividad;",$link);
...
//echo  "Malo";
	...
	mysql_query("update gestion_actividades set tiempo_ejecucion='$tiempo_actividad' where id='$codigo_actividad'",$link);//actualizar  
}
...
$consulta_objetivos_operativos="Select avg(tiempo_ejecucion) promedio from gestion_actividades where cod_plan_operativo='$codigo_plan_operativo'";
...
mysql_query("update gestion_obj_operativos set tiempo_ejecucion='$tiempo_o_operativo' where cod_plan_o_dir='$codigo_plan_operativo'",$link);
/////////////////////////////OBJETIVOS OPERATIVOS////////////////////////////////////////////

/////////////////////////////PLANES OPERATIVOS////////////////////////////////////////////
$consulta_obj_operativo="Select avg(tiempo_ejecucion) promedio from gestion_obj_operativos where codigo='$cod_obj'";
...
mysql_query("update gestion_planes_operativos set tiempo_ejecucion='$tiempo_plan_operativo' where codigo='$codigo_plan_operativo'",$link);
/////////////////////////////PLANES OPERATIVOS////////////////////////////////////////////


/////////////////////////////OBJETIVOS ESTRATEGICOS DIRECCIONES////////////////////////////////////////////
$consulta_plan_operativo="Select avg(tiempo_ejecucion) promedio from gestion_planes_operativos where codigo='$codigo_plan_operativo'";
...
mysql_query("update gestion_obj_estrategicos_direcciones set tiempo_ejecucion='$tiempo_objetivo_direccion' where codigo='$cod_obj_estrategico'",$link);
/////////////////////////////OBJETIVOS ESTRATEGICOS DIRECCIONES////////////////////////////////////////////

/////////////////////////////PLANES ESTRATEGICOS DIRECCIONES////////////////////////////////////////////
$consulta_obj_direccion="Select avg(tiempo_ejecucion) promedio from gestion_obj_estrategicos_direcciones where codigo='$cod_obj_estrategico'";
...
mysql_query("update gestion_planes_estrategicos_direcciones set tiempo_ejecucion='$tiempo_plan_direccion' where codigo='$codigo_plan_estrategico_direccion'",$link);
/////////////////////////////PLANES ESTRATEGICOS DIRECCIONES////////////////////////////////////////////

/////////////////////////////OBJETIVOS ESTRATEGICOS ORGANIZACION////////////////////////////////////////////
$consulta_plan_direccion="Select avg(tiempo_ejecucion) promedio from gestion_planes_estrategicos_direcciones where codigo='$codigo_plan_estrategico_direccion'";
...
mysql_query("update gestion_obj_estrategicos set tiempo_ejecucion='$tiempo_obj_organizacion' where codigo='$cod_obj_organizacion'",$link);
/////////////////////////////OBJETIVOS ESTRATEGICOS ORGANIZACION////////////////////////////////////////////

/////////////////////////////PLANES ESTRATEGICOS ORGANIZACION////////////////////////////////////////////
$consulta_obj_organizacion="Select avg(tiempo_ejecucion) promedio from gestion_obj_estrategicos where codigo='$cod_obj_organizacion'";
...
mysql_query("update gestion_planes_estrategicos set tiempo_ejecucion='$tiempo_plan_organizacion' where codigo='$codigo_plan_estrategico'",$link);
/////////////////////////////PLANES ESTRATEGICOS ORGANIZACION////////////////////////////////////////////

echo "<script language='javascript'> alert (\"El estado ha sido cambiado correctamente\"); 
	location.href='../fases/incluir_fases.php?codigo_actividad=+$codigo_actividad';";
echo "</script>"; 
mysql_close($link);
?>