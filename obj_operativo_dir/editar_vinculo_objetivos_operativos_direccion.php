...
<title>Objetivos Operativos Direcci&oacute;n</title>
...
<table width="560" border="1" align="center" cellpadding="2">
    <tr class="encabezado" >
      <td colspan="2" id="fila_1"><div align="center" class="style2"><strong><img src="../imag/usuario.png" alt="" width="57" height="45" />Vincular Objetivos Operativos</strong> <strong>Direcci&oacute;n</strong> 
    ...
    <tr>
      ...
      <label>
      <?php
	  $result=mysql_query("SELECT * FROM gestion_obj_operativos WHERE codigo=$_GET[codigo_objetivo]");
	  $row=mysql_fetch_row($result);
	  ?>
