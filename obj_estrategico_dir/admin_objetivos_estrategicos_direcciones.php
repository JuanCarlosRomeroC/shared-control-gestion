...
{
      ajax=nuevoAjax();
      ajax.open("GET", "../eliminar/eliminar.php?seleccionado="+cod+"&elimina=6", true);
      ajax.onreadystatechange=function()
      {
         if (ajax.readyState==4)
		 {
...
<form id="f1" name="form1" method="POST" action="objetivos_estrategicos_direccion.php">
  <table width="600" height="160" border="1" align="center" cellpadding="2">
    <tr class="encabezado">
      <td colspan="2" id="fila_1"><div align="center"><strong><img src="../imag/j0432636.png" alt="" width="54" height="40" />Listado de Objetivos Estrat&eacute;gicos</strong> <strong>Direcci&oacute;n</strong>
    ...
    <tr>
      <td width="31%" align=""><strong>Dirección</strong></td>
      <td width="69%" align="" id="cod"> <div align="justify">
    ...
    <tr>
      <td><strong>Plan Estratégico</strong></td>
      <td height="28" id="plan">
