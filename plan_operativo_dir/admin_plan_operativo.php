 ...
 //alert ("valor "+ valor);
   ...
   else
   {
	 ...
	 // document.write(valor);
      ajax.open("GET", "muestra_planes_operativos.php?seleccionado="+valor+"&cod_org="+document.form1.organizacion.value, true);
      ajax.onreadystatechange=function()
      {
         if (ajax.readyState==1)
         {
...
<title>Sistema Gestión/Dirección/Listado de Planes Operativos</title>
...
<form id="f1" name="form1" method="post" action="plan_operativo.php">
  <table width="600" border="1" align="center" cellpadding="2">
    <tr class="encabezado">
      <td colspan="2" id="fila_3"><div align="center"><strong><img src="../imag/j0432636.png" alt="" width="54" height="40" />Listado de Planes Operativos</strong>
    ...
    <tr>
      <td height="25" colspan="2" id="plan_impacto2">&nbsp;</td>
    </tr>
  </table>
  <p>&nbsp;</p>
