...
{
      ajax=nuevoAjax();
      ajax.open("GET", "../eliminar/eliminar.php?seleccionado="+cod+"&elimina=8", true);
      ajax.onreadystatechange=function()
      {
         if (ajax.readyState==4)
		 {
...
<title>Sistema Gestión/Organización/Listado de Planes Estratégicos </title>
...
<form id="f1" name="form1" method="POST" action="planes_estrategicos.php">
  <table width="600" border="1" align="center" cellpadding="2">
    <tr class="encabezado">
      <td colspan="2" align="center" id="fila_1"><div align="center"><strong><img src="../imag/j0432636.png" alt="" width="54" height="40" />Listado de Planes Estrat&eacute;gicos Organizaci&oacute;n</strong><strong></strong>
    ...
    <tr>
      <td height="25" colspan="2" id="plan2">&nbsp;</td>
    </tr>
  </table>
  <label></label>
</form>
