...
{
$res=mysql_query("SELECT codigo FROM gestion_obj_operativos where cod_plan_o_dir=$_GET[seleccionado]") or die();
...
{
$res=mysql_query("SELECT codigo FROM gestion_obj_estrategicos where codigo_plan_estrategico=$_GET[seleccionado]") or die();
$row=mysql_fetch_array($res);
$codigo_objetivo_estrategico=$row["codigo"];
...
{
$res=mysql_query("SELECT codigo FROM gestion_planes_estrategicos_direcciones where cod_direccion=$_GET[seleccionado]") or die();
$row=mysql_fetch_array($res);
$codigo_plan_estrategico=$row["codigo"];

$res2=mysql_query("SELECT codigo FROM gestion_planes_operativos where cod_direccion=$_GET[seleccionado]") or die();
$row2=mysql_fetch_array($res2);
$codigo_plan_operativo=$row2["codigo"];

$res3=mysql_query("SELECT codigo FROM gestion_obj_estrategicos_direcciones where cod_plan_e_dir=$codigo_plan_estrategico")or die();
$row3=mysql_fetch_array($res3);
$codigo_objetivo_estrategico=$row3["codigo"];

$res4=mysql_query("SELECT codigo FROM gestion_obj_operativos where cod_plan_o_dir=$codigo_plan_operativo")or die();
$row4=mysql_fetch_array($res4);
$codigo_objetivo_operativo=$row4["codigo"];

 $sql="DELETE FROM gestion_direcciones where codigo=$_GET[seleccionado]";
 $result=mysql_query($sql);
 $sql1="DELETE FROM gestion_planes_estrategicos_direcciones where cod_direccion=$_GET[seleccionado]";
 $result1=mysql_query($sql1);
 $sql2="DELETE FROM gestion_obj_estrategicos_direcciones where cod_plan_e_dir=$codigo_plan_estrategico";
 $result2=mysql_query($sql2);
 $sql3="DELETE FROM gestion_plan_e_org_dir where cod_plan_e_dir=$codigo_plan_estrategico";
 $result3=mysql_query($sql3);
  $sql4="DELETE FROM gestion_plan_e_o_dir where cod_plan_e_dir=$codigo_plan_estrategico";
 $result4=mysql_query($sql4);
 $sql5="DELETE FROM gestion_planes_operativos where cod_direccion=$_GET[seleccionado]";
 $result5=mysql_query($sql5);
 $sql6="DELETE FROM gestion_obj_operativos where cod_plan_o_dir=$codigo_plan_operativo";
 $result6=mysql_query($sql6);
 $sql7="DELETE FROM gestion_obje_org_dir where cod_obj_e_dir=$codigo_objetivo_estrategico";
 $result7=mysql_query($sql7);
 $sql8="DELETE FROM gestion_obj_operativos_actividades where cod_obj_operativo=$codigo_objetivo_operativo";
