...
<title>Indicadores Planes Estrat&eacute;gicos Direcci&oacute;n</title> 
...
$sql=mysql_query("select * from gestion_planes_estrategicos_direcciones where codigo=$cod") or die (mysql_error);
...
<form name="form1" method="post" action="">
  ...
  <table width="626" border="1" align="center">
    ...
    <tr>
      <td> <div align="center"> <div id="demo2">
        <div align="center">
          <script>display ('element2',<?php echo $completados?>,1);</script>
          <span>Completado</span></div>
      </div></td>
      <td height="42"><div align="center">
        <?php if ($result[7]=='0') echo "<img src='../imag/retraso_grave.png' height='55' border='0' title='Muy Retrasada'/>"; else if ($result[7]=='1') echo "<img src='../imag/retraso_moderado.png' border='0' height='55' title='Retraso Moderado'/>"; else if ($result[7]=='2') echo "<img src='../imag/en_tiempo.png' border='0' height='55' title='En Tiempo'/>";?>
        <?php if ($result[7]=='0') echo "Retraso Grave"; else if ($result[7]=='1') echo "Retraso Moderado"; if ($result[7]=='2') echo "En Tiempo";?>
      </div>      </td>
      <td><a href="objetivos_direccion.php?seleccionado=<?php echo $cod ?>"><img src="../imag/demo.png" width="58" height="50" border="0" title="Ver Detalles"></a></td>
    </tr>
    <tr class="encabezado">
      <td height="23" colspan="3">
        <div align="center"><a href="plan_estrategico_direccion.php">
