...
<form id="form1" name="form1" method="post" action="">
    ...
    <tr>
      ...
      <td><div align="center"><a href="barra_planes_operativos.php?seleccionado=<?php echo $row["codigo"] ?>"><img src="../imag/log.png" width="78" height="40" border="0"  title="Ver Gr&aacute;ficas"/></a><a href="barra_planes_operativos.php?seleccionado=<?php echo $row["codigo"] ?>"></a></div></td>
      </tr>
    <?php }?>
  </table>
