...
$sql=mysql_query("select * from gestion_planes_operativos where codigo=$cod") or die (mysql_error);
...
<form name="form1" method="post" action="">
  ...
  <table width="626" border="1" align="center">
    ...
    <tr>
      ...
      <td><a href="objetivos_operativos.php?seleccionado=<?php echo $cod ?>"><img src="../imag/demo.png" width="58" height="50" border="0" title="Ver Detalles"></a></td>
    </tr>
    <tr class="encabezado">
